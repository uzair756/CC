...
export const RefLogin = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await fetch(`http://192.168.139.169:3002/reflogin`, {
        method: 'POST',
      ...
      >
        <View style={styles.overlay}>
          <View style={styles.card}>
            <Text style={styles.title}>Ref Login</Text>
            <Text style={styles.subtitle}>Manage live scoring, events and match timeline</Text>

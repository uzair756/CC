...
export const RepLogin = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await fetch(`http://192.168.139.169:3002/studentreplogin`, {
        method: 'POST',
      ...
      >
        <View style={styles.overlay}>
          <View style={styles.card}>
            <Text style={styles.title}>Rep Login</Text>
            <Text style={styles.subtitle}>Manage your team's participation</Text>

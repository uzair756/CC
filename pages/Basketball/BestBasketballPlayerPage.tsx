...
export const BestBasketballPlayerPage = ({ navigation }) => {
    ...
    const fetchBestFootballer = async () => {
        ...
        try {
            ...
            const response = await fetch("http://192.168.1.24:3002/bestbasketballplayer", {
                method: "GET",
                headers: {
            ...
            setError(error.message || "Failed to fetch best basketball player");
        } finally {
            setLoading(false);
            setRefreshing(false);
        }
        ...
        <LinearGradient colors={['#0f2027', '#203a43', '#2c5364']} style={styles.container}>
            ...
            >
                <View style={styles.header}>
                    <Text style={styles.heading}>Best Basketball Player</Text>

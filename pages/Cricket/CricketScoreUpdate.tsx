...
const [confirmExtraTeam, setConfirmExtraTeam] = useState<string | null>(null);
  ...
  const handleStart = async matchId => {
    try {
      ...
      const response = await fetch(
        'http://10.4.36.23:3002/startmatchcricket',
        {
          method: 'POST',
          headers: {
  ...
  const handleFirstInning = async () => {
    if (matchDetails.inning === 1) {
      try {
        ...
        const response = await fetch(
          'http://10.4.36.23:3002/updateFirstInningcricket',
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
  ...
  const handleWicketSelection = async newBatsman => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://10.4.36.23:3002/swapPlayerscricket',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleAllOut = async () => {
    try {
      ...
      const response = await fetch(
        'http://10.4.36.23:3002/handlealloutinning1',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleOverSelection = async newBowler => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://10.4.36.23:3002/swapbowlercricket',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleConfirmByes = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://10.4.36.23:3002/updateByesCricket',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleConfirmExtras = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://10.4.36.23:3002/updateExtrasCricket',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',

...
const [isRunOutModalVisible, setIsRunOutModalVisible] = useState(false);
  ...
  const handleStop = async matchId => {
    try {
      ...
      const response = await fetch(
        'http://3.0.218.176:3002/stopmatchcricket',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleWicketSelection = async newBatsman => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://3.0.218.176:3002/swapPlayerscricket2ndInning',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleOverSelection = async newBowler => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://3.0.218.176:3002/swapbowlercricket2ndInning',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleConfirmByes = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://3.0.218.176:3002/updateByesCricket2ndInning',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleConfirmExtras = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://3.0.218.176:3002/updateExtrasCricket2ndInning',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleAllOut = async () => {
    try {
      ...
      const response = await fetch(
        'http://3.0.218.176:3002/handlealloutinning2',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',

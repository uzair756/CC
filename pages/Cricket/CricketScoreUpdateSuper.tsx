...
export const CricketSuperOver = ({navigation}) => {
  ...
  const handleStartSuperOver = async () => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch('http://3.0.218.176:3002/startSuperOver', {
        method: 'POST',
        headers: {
  ...
  const handleConfirmScoreIncrement = async index => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://3.0.218.176:3002/updateSuperOverScore',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const prepareSecondInning = async () => {
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://3.0.218.176:3002/prepareSuperOverSecondInning',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleWicketSelection = async newBatsman => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://3.0.218.176:3002/updateSuperOverWicket',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const updateMatchResult = async winner => {
    try {
      const token = await AsyncStorage.getItem('token');
      await fetch('http://3.0.218.176:3002/completeSuperOver', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const handleConfirmByes = async () => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://3.0.218.176:3002/updateSuperOverByes',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleExtras = async type => {
    ...
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await fetch(
        'http://3.0.218.176:3002/updateSuperOverExtras',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',

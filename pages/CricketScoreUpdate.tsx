...
export const CricketScoreUpdatePage = ({ navigation }) => {
  ...
  const renderMatchItem = ({ item }) => (
    <View style={styles.matchItem}>
      ...
      <View style={styles.matchCard}>
        ...
        <Text style={styles.scoreTeamName} >Team {item.team1} Score Buttons</Text>
         <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT1(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T1 (W)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT1(item._id)}
          ...
          <TouchableOpacity 
            ...
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T1 (+2)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT1(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T1 (+3)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT1(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T1 (+4)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT1(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T1 (+5)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT1(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T1 (+6)</Text>
          </TouchableOpacity>
          <Text style={styles.scoreTeamName} >Team {item.team2} Score Buttons</Text>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT2(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T2 (W)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT2(item._id)}
          ...
          <TouchableOpacity 
            ...
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T2 (+2)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT2(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T2 (+3)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT2(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T2 (+4)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT2(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T2 (+5)</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionButton} 
            onPress={() => handleAddScoreT2(item._id)}
            disabled={!isTimerRunning || activeMatchId !== item._id}
          >
            <Text style={styles.actionButtonText}>T2 (+6)</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  scoreTeamName: {
    textAlign: 'center', width: '100%',fontSize:15,color:'white',fontWeight:'bold',marginBottom:5,marginTop:5
  }
});

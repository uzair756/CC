...
export const TableTennisScoreUpdatePage = ({ route,navigation }) => {
  ...
  const swapPlayers = async () => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.1.9:3002/swapPlayerstennis', {
        method: 'POST',
  ...
  const handleStart = async (matchId) => {
    try {
      ...
      const response = await fetch('http://192.168.1.9:3002/startmatchtennis', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const handleStop = async (matchId) => {
    try {
      ...
      const response = await fetch('http://192.168.1.9:3002/stopmatchtennis', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
        body: JSON.stringify({ matchId }),
      });
  ...
  const handlePointIncrement = async (playerId, team) => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.1.9:3002/updateGoaltennis', {
        method: 'POST',
        headers: {
  ...
  const handleEndQuarter = async (currentQuarter) => {
    try {
        ...
        const response = await fetch('http://192.168.1.9:3002/updateHalftennis', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
...
const handleEnd3rdQuarter = async () => {
  try {
      ...
      const response = await fetch('http://192.168.1.9:3002/updateHalf3rdtennis', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },

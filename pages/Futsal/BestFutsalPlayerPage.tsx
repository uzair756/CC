...
export const BestFutsalPlayerPage = ({ navigation }) => {
    ...
    const fetchBestFootballer = async () => {
        ...
        try {
            ...
            const response = await fetch("http://192.168.139.169:3002/bestfutsalplayer", {
                method: "GET",
                headers: {
            ...
            if (data.success) {
                setBestFootballer(data.bestFutsalPlayer);
            } else {
        ...
        <LinearGradient colors={['#0f2027', '#203a43', '#2c5364']} style={styles.container}>
            ...
            >
                <View style={styles.header}>
                    <Text style={styles.heading}>Best Futsal Player</Text>

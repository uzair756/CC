...
export const TugofWarScoreUpdatePage = ({ route,navigation }) => {
  ...
  const swapPlayers = async () => {
    ...
    try {
      ...
      const response = await fetch('http://3.0.218.176:3002/swapPlayerstugofwar', {
        method: 'POST',
  ...
  const handleStart = async (matchId) => {
    try {
      ...
      const response = await fetch('http://3.0.218.176:3002/startmatchtugofwar', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const handleStop = async (matchId) => {
    try {
      ...
      const response = await fetch('http://3.0.218.176:3002/stopmatchtugofwar', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
        body: JSON.stringify({ matchId }),
      });
  ...
  const handlePointIncrement = async (playerId, team) => {
    ...
    try {
      ...
      const response = await fetch('http://3.0.218.176:3002/updateGoaltugofwar', {
        method: 'POST',
        headers: {
  ...
  const handleEndQuarter = async (currentQuarter) => {
    try {
        ...
        const response = await fetch('http://3.0.218.176:3002/updateHalftugofwar', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
...
const handleEnd3rdQuarter = async () => {
  try {
      ...
      const response = await fetch('http://3.0.218.176:3002/updateHalf3rdtugofwar', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
